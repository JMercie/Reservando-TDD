...
var Juego = {
  ...
  obstaculosCarretera: [
    ...
    new Obstaculo('imagenes/valla_horizontal.png', 500, 100, 30, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 500, 400, 30, 30, 1),
    new Obstaculo('imagenes/bache.png', 60, 234, 30, 30, 2),
    new Obstaculo('imagenes/bache.png', 770, 200, 30, 30, 2),
    new Obstaculo('imagenes/bache.png', 90, 234, 30, 30, 2),
    new Obstaculo('imagenes/bache.png', 120, 234, 30, 30, 2),
    new Obstaculo('imagenes/bache.png', 100, 400, 30, 30, 2),
    new Obstaculo('imagenes/valla_vertical.png', 70, 300, 30, 30, 1),
    new Obstaculo('imagenes/valla_vertical.png',530 , 430, 30, 30, 1),
    new Obstaculo('imagenes/valla_vertical.png', 500, 120, 30, 30, 1),
    new Obstaculo('imagenes/valla_vertical.png', 160, 420, 30, 30, 1),
    new Obstaculo('imagenes/auto_verde_abajo.png', 790, 230, 15, 30, 3),
    new Obstaculo('imagenes/auto_verde_derecha.png', 100, 460, 30, 15, 3),
    new Obstaculo('imagenes/auto_verde_derecha.png', 80, 200, 30, 15, 3),
    new Obstaculo('imagenes/auto_verde_derecha.png', 300, 460, 30, 15, 3),
  ],
  ...
  enemigos: [
    new ZombieCaminante('imagenes/zombie1.png', 100, 100, 10, 10, 2, {desdeX: 0, 
			hastaX: 961, 
			desdeY: 0, 
			hastaY: 577
    }),
    new ZombieCaminante('imagenes/zombie1.png', 120, 120, 10, 10, 2, {desdeX: 0, 
			hastaX: 961, 
			desdeY: 0, 
			hastaY: 577
    }),
    new ZombieCaminante('imagenes/zombie1.png', 160, 160, 10, 10, 2,{desdeX: 0, 
			hastaX: 961, 
			desdeY: 0, 
			hastaY: 561
    } ),
    new ZombieCaminante('imagenes/zombie1.png', 240, 240, 10, 10, -2, {desdeX: 0, 
			hastaX: 961, 
			desdeY: 0, 
			hastaY: 561
    }),
    new ZombieCaminante('imagenes/zombie2.png', 300, 300, 10, 10,- 2, {desdeX: 0, 
			hastaX: 961, 
			desdeY: 0, 
			hastaY: 561
    }),
    new ZombieCaminante('imagenes/zombie2.png', 600, 600, 10, 10, -2, {desdeX: 0, 
			hastaX: 961, 
			desdeY: 0, 
			hastaY: 561
    }),
    new ZombieCaminante('imagenes/zombie2.png', 200, 200, 10, 10, -2, {desdeX: 0, 
			hastaX: 961, 
			desdeY: 0, 
			hastaY: 561
    }),
    ///////de aqui para abajo son zombies conductores ///
    new ZombieConductor('imagenes/tren_horizontal.png', 400, 322, 90, 30, 5, {desdeX: 0, 
			hastaX: 870, 
			desdeY: 322, 
			hastaY: 322
		}, "h"),
    new ZombieConductor('imagenes/tren_vertical.png', 644, 0, 30, 90, 5, {desdeX: 644, 
			hastaX: 644, 
			desdeY: 0, 
			hastaY: 577
    }, "v"),
    new ZombieConductor('imagenes/tren_vertical.png', 678, 0, 30, 90, 5, {desdeX: 678, 
			hastaX: 678, 
			desdeY: 0, 
			hastaY: 577
    }, "v")
...
Juego.capturarMovimiento = function(tecla) {
  ...
  if (this.chequearColisiones(movX + this.jugador.x, movY + this.jugador.y)) {
    ...
    this.jugador.mover = function (x, y){
      if (x < 0) {
        realizarMovimiento('imagenes/auto_rojo_izquierda.png', 30,15)
      } else if (y < 0) {
        realizarMovimiento('imagenes/auto_rojo_arriba.png', 15, 30)
      } else if (x > 0 ) {
        realizarMovimiento('imagenes/auto_rojo_derecha.png',30, 15)
      } else if (y > 0) {
        realizarMovimiento('imagenes/auto_rojo_abajo.png', 15, 30)
      }
      this.x += movX;
      this.y += movY;
    }
...
function realizarMovimiento (spriteJugado, spriteAncho, spriteAlto){
  Jugador.sprite = spriteJugado;
  Jugador.ancho = spriteAncho;
  Jugador.alto = spriteAlto;
};
...
Juego.chequearColisiones = function(x, y) {
  ...
  this.obstaculos().forEach(function(obstaculo) {
    if (this.intersecan(obstaculo, this.jugador, x, y)) {
      ...
      this.obstaculo.chocar(this.x, this.y)
      puedeMoverse = false
    }
  }, this)
  return puedeMoverse
