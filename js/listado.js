...
// Creo un array con elementos unicos //
function listaUnica (listdoConRepetidos) {
    var listadoUnico = listdoConRepetidos.filter(function(elem, index, self) {
...
Listado.prototype.obtenerUbicaciones = function() {
    var ubicacionRepetida = this.restaurantes.map(restaurant => restaurant.ubicacion);
    
    var ubicaciones = listaUnica(ubicacionRepetida);
...
Listado.prototype.obtenerRubros = function() {
    var rubrosRepetido = this.restaurantes.map(restaurant => restaurant.rubro);
    
    var rubros = listaUnica(rubrosRepetido);
...
Listado.prototype.obtenerHorarios = function() {
    ...
    var horarios = listaUnica(horariosRepetidos);
